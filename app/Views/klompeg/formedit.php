...
<div class="modal fade" id="modaledit" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?=form_open('klompeg/updatedata/'.$id_klompeg, ['class'=>'formklompeg'])?>
            <?=csrf_field();?>

            <div class="modal-header">
                <h5 class="modal-title">Edit Klompeg</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Nama Klompeg*</label>
                    <input name="nama_klompeg" id="nama_klompeg" type="text" class="form-control"
                        placeholder="Contoh: Kantor Kecamatan Nusawungu" value="<?=$nama_klompeg?>">
