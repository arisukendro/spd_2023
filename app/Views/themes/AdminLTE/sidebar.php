<li class="nav-item">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
            <a href="<?=site_url('surattugas/tambah')?>" class="nav-link ">
                <i class="far fa-circle nav-icon"></i>
                <p>Buat Baru</p>
            </a>
        </li>
        <li class="nav-item">
            <a href="<?=site_url('surattugas')?>" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Lihat Data</p>
            </a>
        </li>
...
<li class="nav-item">
    <a href="<?=site_url('spd')?>" class="nav-link">
...
<li class="nav-header text-bold text-warning">MASTER DATA</li>
<li class="nav-item">
...
<li class="nav-item">
    <a href="<?=site_url('instansi')?>" class="nav-link">
...
<li class="nav-item">
    <a href="<?=site_url('subbag')?>" class="nav-link">
        <i class="nav-icon fa fa-indent"></i>
        <p>
            Data Subbag/Divisi
        </p>
